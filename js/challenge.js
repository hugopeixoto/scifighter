...
quizQuestions[Challenge.types.MONSTER].push(new quizQuestion("4 * (x - 8) = 36",["17","19","20","16"],0));
quizQuestions[Challenge.types.MONSTER].push(new quizQuestion("(x + 7) - (4 * x) = 1",["4","2","3","5"],1));
